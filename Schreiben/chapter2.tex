...
Um das Kapitel abzuschließen, erfolgt eine Beschreibung der wichtigsten beiden Varianten der Singulärwertzerlegung.
...
Zusammenfassend zerlegt also die Singulärwertzerlegung eine Matrix in grundlegende geometrische Transformationen: Drehung, Skalierung und gegebenenfalls Dimensionsreduktion.

Mit dieser Erkenntnis wird sich dem letzten Abschnitt des theoretischen Teils zugewandt, in dem die wichtigsten beiden Varianten der SVD beschrieben werden.

\section{Varianten der SVD}
