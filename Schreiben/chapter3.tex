...
Das Ziel ist, einen Einheitsvektor \(u\) zu finden, sodass nach Projektion der \(x^{(i)}\) auf \(u\) eine maximale Varianz, also eine maximale quadratische Abweichung vom Mittelwert, erhalten bleibt.
