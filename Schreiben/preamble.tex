...
\usepackage{verbatim}
% Subfigures
\usepackage[labelformat=brace, singlelinecheck=false, skip=1pt, font=footnotesize]{subcaption}
% Font
\usepackage{fontspec}
...
\usepackage{enumitem}
% Bibliography
\usepackage[backend=biber,style=alphabetic,sorting=none,doi=false,isbn=false,url=false,giveninits=true, block=ragged]{biblatex}
...
\definecolor{colexam}{RGB}{200, 205, 207}
...
% Chapter and chapter number font
