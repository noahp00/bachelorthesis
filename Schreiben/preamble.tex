...
\usepackage{graphicx}
% Nice tables
\usepackage{longtable, booktabs, diagbox}
% Lists
\usepackage{enumitem}
% Bibliography
\usepackage[backend=biber,style=alphabetic,sorting=none,doi=false,isbn=false,giveninits=true, block=ragged]{biblatex}
...
% Url only for documents and websites
\AtEveryBibitem{%
  \ifentrytype{online}{%
  }{%
    \ifentrytype{misc}{%
